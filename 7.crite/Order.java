  ...
  implements Serializable
{
  ...
  public String toSqlString(Criteria criteria, CriteriaQuery criteriaQuery)
  {
    ...
    for (int i = 0; i < columns.length; i++)
    {
      ...
      fragment.append(factory
        .getDialect().renderOrderByElement(expression
        .toString(), null, this.ascending ? "asc" : "desc", this.nullPrecedence != null ? this.nullPrecedence : factory
        
        .getSettings().getDefaultNullPrecedence()));
  ...
  public String toString()
  {
    return 
      ...
      this.propertyName + ' ' + (this.ascending ? "asc" : "desc") + (this.nullPrecedence != null ? ' ' + this.nullPrecedence.name().toLowerCase(Locale.ROOT) : "");
  }
}
