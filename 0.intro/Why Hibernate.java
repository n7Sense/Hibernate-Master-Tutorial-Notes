...
-------------------
	...
	3. Error Codes was generated by the JDBC technology. which is NOT understandable like ORA-666
	4. We need to write Boilar Plate Codes (i.e we need to write some Duplicate code each and every time in our application)
		Example: if we have 10-Servlet, then each Servlet required to load 
			-Driver Class
			-Pass the URL with User Name - Password
			-Statement 
			-ExecuteStatement.
		...
		------------
			...
			Example: If you want to develope with Servlet application there is 3-way
				...
				1. impplement Servlet{
				 ...
				 ejbActivate()
				 A container invokes this method when the instance is taken out of the pool of available instances to become associated with a specific
				 EJB object.
...
IN ORDER TO OVERCOME THIS ALL PROBLEMS, INDUSTRIES PEOPLES WAS INTRODUCE THE technology i.e ORM TOOL like
Hibernate
JPA
iBaties
topLink etc.
...
applicatiuon server
 ...
 But present the development inside uising the server  is not good aproach i.e the reason Hibernate people was going to be given
